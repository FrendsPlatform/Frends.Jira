...
public class Jira
{
    ...
    public static async Task<Result> GetIssue([PropertyTab] Connection connection, [PropertyTab] Input input, [PropertyTab] Options options, CancellationToken cancellationToken)
    {
        try
        {
            ...
            else
            {
                if (options.ThrowOnError)
                    throw new Exception($"Error retrieving issue: {response.StatusCode}, {data}");
                else
