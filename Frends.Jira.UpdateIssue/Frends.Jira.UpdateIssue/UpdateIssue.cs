...
public class Jira
{
    ...
    public static async Task<Result> UpdateIssue([PropertyTab] Connection connection, [PropertyTab] Input input, [PropertyTab] Options options, CancellationToken cancellationToken)
    {
        try
        {
            ...
            if (response.IsSuccessful)
            {
                ...
                else
                {
                    if (options.ThrowOnError)
                        throw new Exception($"Error updating issue, Status code: {updateResponse.StatusCode}, Content: {updateResponse.Content}.");
                    else
